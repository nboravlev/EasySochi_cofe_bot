"""new column public.drink_adds.is_active

Revision ID: 190fe1817ba0
Revises: d8b654680c0a
Create Date: 2025-09-07 15:06:41.471132
...
revision: str = '190fe1817ba0'
down_revision: Union[str, Sequence[str], None] = 'd8b654680c0a'
...
def upgrade() -> None:
    ...
    op.add_column('drink_adds', sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('drink_adds', 'is_active')
    # ### end Alembic commands ###
