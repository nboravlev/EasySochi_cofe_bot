...
class Order(Base):
    ...
    drink_size_id = Column(Integer, ForeignKey("public.drink_sizes.id", ondelete="CASCADE"), nullable=False)
    status_id = Column(Integer, ForeignKey("public.order_statuses.id", ondelete="CASCADE"), nullable=False)    
    drink_count = Column(Integer, nullable=False)    
    ...
    drink_size = relationship("DrinkSize", back_populates="orders")
    status = relationship("OrderStatus", back_populates="orders")
    order_adds = relationship("OrderAdd", back_populates="order")
